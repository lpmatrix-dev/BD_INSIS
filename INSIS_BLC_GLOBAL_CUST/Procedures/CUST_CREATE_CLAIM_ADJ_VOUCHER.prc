CREATE OR REPLACE PROCEDURE INSIS_BLC_GLOBAL_CUST."CUST_CREATE_CLAIM_ADJ_VOUCHER" 
...
IS
   ...
   l_acc_doc_id         NUMBER;
BEGIN
  cust_acc_process_pkg.Create_Claim_Adj_Voucher
  ...
  --
  COMMIT;
END CUST_CREATE_CLAIM_ADJ_VOUCHER;
/
