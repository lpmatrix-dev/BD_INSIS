CREATE OR REPLACE PROCEDURE INSIS_BLC_GLOBAL_CUST.CUST_CREATE_CLAIM_CORI_VOUCHER 
...
IS
   ...
   l_acc_doc_id         NUMBER;
BEGIN
  cust_acc_process_pkg.Create_Claim_CORI_Voucher
    ( pi_clearing_id   => NULL,
  ...
  --
  COMMIT;
END CUST_CREATE_CLAIM_CORI_VOUCHER;
/
