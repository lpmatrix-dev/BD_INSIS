CREATE OR REPLACE PROCEDURE INSIS_BLC_GLOBAL_CUST."CUST_CREATE_PROFORMA_VOUCHER" 
...
IS
   ...
   l_acc_doc_id         NUMBER;
BEGIN
  cust_acc_process_pkg.Create_Proforma_Voucher
    ( pi_doc_id       => NULL,
  ...
  --
  COMMIT;
END CUST_CREATE_PROFORMA_VOUCHER;
/
