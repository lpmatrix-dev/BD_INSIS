CREATE OR REPLACE PACKAGE BODY INSIS_BLC_GLOBAL_CUST.BLC_RI_PKG AS
    ...
    */
    ...
    BEGIN
        FOR l_copa_item IN (
            ...
            DBMS_OUTPUT.put_line('l_copa_item.COPA_TYPE=' || l_copa_item.COPA_TYPE);
            DBMS_OUTPUT.put_line('l_copa_item.DESCRIPTION=' || l_copa_item.DESCRIPTION);
            --
            ...
            THEN
                BEGIN
                    DBMS_OUTPUT.put_line('l_copa_type=' || l_copa_type);
                    DBMS_OUTPUT.put_line('l_id_insis=' || l_id_insis);
                    --
                    BEGIN
                        SELECT
                            ID_SAP
                    ...
                    END;
                    --
                    DBMS_OUTPUT.put_line('l_copa_value=' || l_copa_value);
                    --
    ...
    --
        ...
        CURSOR c_BLC_REI_GEN_A (
            ...
            WHERE
                ...
                GEN.STATUS = 'N' AND
                (GEN.IP_CODE IS NULL OR GEN.IP_CODE = 'I018') --07.11.2019 - Dora - add to select only RI bill transactions
            ORDER BY
                GEN.ID;
...
*/
            ...
            LOOP
                ...
                r_IIB_REI_GEN.SGLOSA :=
                    ...
                    END;
                r_IIB_REI_GEN.DEFFECDATE := last_day(r_BLC_REI_GEN.DOC_ISSUE_DATE);
                ...
                LOOP
                    BEGIN
                        ...
                        THEN
                            ...
                            --DBMS_OUTPUT.put_line('r_BLC_REI_ACC.ACCOUNT:'|| r_BLC_REI_ACC.ACCOUNT);
                            r_IIB_REI_ACC.SGLOSA :=
                                ...
                                END;
                            --DBMS_OUTPUT.put_line('r_IIB_REI_ACC.SGLOSA:'||r_IIB_REI_ACC.SGLOSA);
                            --DBMS_OUTPUT.put_line('r_BLC_REI_GEN.CURRENCY:'||r_BLC_REI_GEN.CURRENCY);
                            ...
                            r_IIB_REI_ACC.NORI_AMO :=
                                ...
                                END;
                            /* FIXME Mapping */
                            --DBMS_OUTPUT.put_line('r_BLC_REI_GEN.INSURER_PARTY:'||r_BLC_REI_GEN.INSURER_PARTY);
                            ...
                            DBMS_OUTPUT.PUT_LINE('NSEQUENCE=' || r_IIB_REI_ACC.NSEQUENCE);
                            DBMS_OUTPUT.PUT_LINE('NITEM_NUM=' || r_IIB_REI_ACC.NITEM_NUM);
                    ...
                    EXCEPTION
                        WHEN OTHERS THEN
                            --DBMS_OUTPUT.PUT_LINE('ERROR IN REI ACC PROCESS. ');
    ...
    EXCEPTION
        WHEN OTHERS THEN
            --DBMS_OUTPUT.PUT_LINE('ERROR IN REI HEADER PROCESS. ');
            --
